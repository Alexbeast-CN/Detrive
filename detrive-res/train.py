...
from model import DETRIVE
from data import CARLA_Data
from config import GlobalConfig


parser = argparse.ArgumentParser()
parser.add_argument('--id', type=str, default='detrive', help='Unique experiment identifier.')
parser.add_argument('--device', type=str, default='cuda', help='Device to use')
parser.add_argument('--epochs', type=int, default=301, help='Number of train epochs.')
...
# Model
model = DETRIVE(config, args.device)
